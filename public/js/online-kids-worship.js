...
function loadChat() {
  if ((moment().format('ddd') === 'Sat') && (moment().isBetween(moment('10:30', 'H:mm'), moment('12:30', 'H:mm')))) {
    if (!username) {
    ...
    $("#sidebarMain").html(`<h4 class="m-3">Chat is available on Saturday from 10:30am until 12:30pm.</h4>`)
  }
}
