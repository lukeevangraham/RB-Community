...
function loadChat() {
  if ((moment().format('ddd') === 'Fri') && (moment().isBetween(moment('18:00', 'H:mm'), moment('20:30', 'H:mm')))) {
    if (!username) {
    ...
    $("#sidebarMain").html(`<h4 class="m-3">Chat is available on Friday from 6:00pm until 8:30pm.</h4>`)
  }
}
